...
from fastup.core.protocols import IDGen


async def test_ids_generated_in_a_batch_are_all_unique(idgen: IDGen):
    """
...
async def test_a_later_id_is_always_greater_than_an_earlier_id(idgen: IDGen):
    """
...
async def test_a_sequence_of_generated_ids_is_correctly_sorted(idgen: IDGen):
    """
